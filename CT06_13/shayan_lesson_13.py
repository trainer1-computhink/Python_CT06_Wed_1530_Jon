...
#user_acc_bal = 1000
#while True:
#    user = input("Would you like to Withdraw,Deposit,Check Balance or Exit?")
#    if user == "Withdraw":
#        user_draw = int(input("How much to draw?"))
#        if user_draw > 1000:
#            print("Not enough money in account.")
#        else:
#            user_acc_bal = user_acc_bal - user_draw
#            print("You now have",user_acc_bal,"dollars left")
#    if user == "Deposit":
#        user_deposit = int(input("How much to deposit?"))
#        user_acc_bal = user_deposit + user_acc_bal
#        print("You now have",user_acc_bal,"dollars left")
#    if user == "Check Balance":
#        print("You have",user_acc_bal,"currently")
#    if user == "Exit":
#        print("Goodbye")
...
groceries[4] = "papaya"
groceries.append("mangosteen")
groceries.insert(2,"guava")
del(groceries[4])
removed_grocery = groceries.pop(4)
groceries.append("grapes")
print(removed_grocery)
